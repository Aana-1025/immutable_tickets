...
public final class Validation {
    ...
    public static void requireMaxLen(String value, int max, String fieldName) {
        if (value != null && value.length() > max) {
            throw new IllegalArgumentException(
                    fieldName + " must be <= " + max + " chars"
            );
        }
    }

    public static void requireEmail(String email, String fieldName) {
        if (email == null) return; // optional fields allowed
    ...
    public static void requireOneOf(String value,
                                    String fieldName,
                                    String... allowed) {
    ...
    public static void requireRange(Integer value,
                                    int min,
                                    int max,
                                    String fieldName) {
